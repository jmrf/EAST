        ...
        for i in range(4):
            ...
            if point_dist_to_line(p0, p3, p1) > point_dist_to_line(p0, p3, p2):
                ...
                if backward_edge[1] == 0:
                    ...
                    backward_opposite = [backward_edge[
                        0], -1, p1[1] - backward_edge[0] * p1[0]]
            else:
                # across p2
                if backward_edge[1] == 0:
                    ...
                    backward_opposite = [backward_edge[
                        0], -1, p2[1] - backward_edge[0] * p2[0]]
            new_p1 = line_cross_point(backward_opposite, edge)
            new_p2 = line_cross_point(backward_opposite, edge_opposite)
            fitted_parallelograms.append(
                [new_p0, new_p1, new_p2, new_p3, new_p0])
        areas = [Polygon(t).area for t in fitted_parallelograms]
        parallelogram = np.array(fitted_parallelograms[np.argmin(areas)][
                                 :-1], dtype=np.float32)
        # sort thie polygon
            ...
            try:
                ...
                if vis:
                    ...
                    for poly in text_polys:
                        ...
                        axs[0, 0].text(poly[0, 0], poly[
                                       0, 1], '{:.0f}-{:.0f}'.format(poly_h, poly_w), color='purple')
